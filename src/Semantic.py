...
""" MLP Backbone from MindEyev2 (ICML 2024),  https://arxiv.org/abs/2403.11207 """
class Semantic_Reconstruction(nn.Module):
    def __init__(self, h=4096, in_dim=13447, out_dim=768, seq_len=2, n_blocks=4, drop=.15, clip_size=768, blurry_recon=True, clip_scale=1):
        super().__init__()
