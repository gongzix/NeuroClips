...
if blurry_recon:
    ...
    ckpt = torch.load(f'/users/PAS2490/marcusshen/.cache/huggingface/hub/datasets--pscotti--neuroclipsv2/snapshots/183269ab73b49d2fa10b5bfe077194992934e4e6/sd_image_var_autoenc.pth')
...
if use_prior:
    ...
    checkpoint = torch.load(f'/fs/scratch/PAS2490/neuroclips/weights/datasets--pscotti--neuroclipsv2/snapshots/183269ab73b49d2fa10b5bfe077194992934e4e6/train_logs/final_subj01_pretrained_40sess_24bs/last.pth', map_location='cpu')
    ...
    checkpoint = torch.load(f'/fs/scratch/PAS2490/neuroclips/weights/datasets--pscotti--neuroclipsv2/snapshots/26421f100e4c6012a35ecadb272a0ec1d999202d/train_logs/final_subj01_pretrained_40sess_24bs/last.pth', map_location='cpu')
    model.load_state_dict(checkpoint['model_state_dict'], strict=False)
    del checkpoint
